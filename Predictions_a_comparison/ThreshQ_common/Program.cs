/*
	Leaguesharp.common prediction test
...
namespace ThreshQ_common
{
	public static class Program
	{
		...
		private static void Combo()
		{
			...
			PredictionOutput pred = _q.GetPrediction(tar, false, _q.Range, new []{CollisionableObjects.YasuoWall, CollisionableObjects.Minions});
			try
			{
